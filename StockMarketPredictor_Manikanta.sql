# Creating Database For Assignment #
create database assignment;

# Selecting Database for Further Queries #
use assignment;

#IMPORT Tables from DataSets Downloaded
####################################################################################################
...
# Selecting These Tables and check values#
...
######################################## TASK-2 : Master table creation by joining all the tables created in 1######################################## 
...
######################################## TASK-3:Generating BUY and SELL Signals using Tables Created in TASK-1 ######################################## 
### Creating Temporary tables in order to apply if-else conditions later ###
...
######################################## TASK-4: UDF for taking date as input and return Signal of that day for Bajaj ######################################## 
...
$$
delimiter ;
select input_signal('2015-05-18') as `signal`;
